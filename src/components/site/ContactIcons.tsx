...
const MOCKDATA = [
  ...
  { title: 'Endereço', description: 'Rua Alceu Amoroso Lima, 470, Edifício Empresarial Niemeyer, Sala 606, 607 e 608. Caminho das Árvores, Salvador-BA, 41820-770.', icon: IconMapPin },
...
export function ContactIcons() {
  return (
    <SimpleGrid className='z-20' cols={2} breakpoints={[{ maxWidth: 755, cols: 1 }]}>
      ...
      >
        <div>
          <h1 className='text-white'>Matriz</h1>
        </div>
        {/* <ContactIconsList /> */}
      </Box>
