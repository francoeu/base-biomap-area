          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base mb-7 text-body-color text-white">
                  Biomap Topografia & Locações.
                </p>
              ...
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  ...
                  target="_blank"
                    ...
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-white hover:border-[#0FB268] hover:bg-[#0FB268] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
                  ...
                  target="_blank"
                    ...
                    className="text-white mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:border-[#0FB268] hover:bg-[#0FB268] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={14}
                      height={14}
...
interface LinkGrouProps{
  children: React.ReactNode,
  header: string,
}

const LinkGroup = ({ children, header }: LinkGrouProps) => {
  return (
    <>
