...
import BannerIllustration from '../../../public/banners/bio-illustration-banner.svg';
import MembersLogos from "../MembersLogos";
import ResponsiveBanner from "../site/ResponsiveBanner";
...
export const Footer = () => {
  return (
    <>
      ...
      <footer className="relative z-50 bg-[#151619] px-4 md:px-20 pt-10 pb-10 lg:pt-[120px] border-t-2 border-[#0FB268]">
  ...
  <a
    ...
    className="flex items-center justify-center w-8 h-8 md:w-14 md:h-14 bg-[#0FB268] text-white rounded-full shadow-lg hover:bg-[#0FB268-hover] transform hover:scale-105 transition duration-300 ease-in-out"
  >
   <IconBrandWhatsapp />
  </a>
</div>
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-xs mb-7 text-body-color text-white">
                  Biomap Area. Uma área de membros exclusiva para clientes.
                  Acesse seus projetos e arquivos de forma prática e gratuita.
                </p>
                <MembersLogos />
                {/* <p className="flex items-center text-sm font-medium text-dark">
                  <span className="mr-3 text-[#0FB268]">
                    <svg
                      width={19}
                      height={21}
                      viewBox="0 0 19 21"
            ...
            {/* <LinkGroup header="Resources">
             ...
             <LinkGroup header="A Biomap">
                <div className="flex flex-col gap-4">
                <Link className="text-white hover:text-[#0FB268]"   href="/sobre">Sobre Nós </Link>
              <Link className="text-white hover:text-[#0FB268]"   href="/servicos">Serviços </Link>
              <Link className="text-white hover:text-[#0FB268]"  href="/contato/">Entre em contato </Link>
            ...
            <LinkGroup header="Links Rápidos">
              ...
              <Link className="text-white hover:text-[#0FB268]" target="_blank" href="https://lojabiomap.com.br/">Loja Biomap </Link>
              <Link className="text-white hover:text-[#0FB268]" target="_blank" href="/login">Biomap Area</Link>
                </div>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                <h4 className="text-lg font-semibold mb-9 text-dark">
                  Siga a Biomap Nas Redes Sociais
                </h4>
                <div className="flex items-center mb-6">
                  <Link
                  target="_blank"
                    href="https://www.facebook.com/Biomaptopografia/"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-[#0FB268] hover:bg-[#0FB268] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
                  ...
                  <Link
                  target="_blank"
                    href="https://pt.linkedin.com/company/biomap-engenharia-topografia-e-meio-ambiente"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-[#0FB268] hover:bg-[#0FB268] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={14}
                ...
                <p className="text-base text-body-color">
                  {" "}
                  © {new Date().getFullYear()} Biomap Topografia & Locações{" "}
                </p>
              </div>
            </div>
          </div>
